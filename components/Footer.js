           ...
           <footer className= {`bg-dark ${styles.Footer}`} >
            <div className= { `row`}>
                <div className= {` col-sm-12 col-md-4 col-lg-4`}>
                    <h3 className= {`text-light text-center ${styles.footerColumnHeader}`}>Browser</h3>
                    <ul className= {`d-flex justify-content-center ${styles.footerLinkItems}`}>
                       <li className= {`${styles.LinkItem}`}>
                        <a href = "/" className= {`text-light   ${styles.footerLinks}`}>Home</a>
                       </li>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
            ...
            <h6 className= {`text-center text-dark`}>Coypright @ sell-it-2023</h6>
            </div>
